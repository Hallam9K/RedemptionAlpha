...
{
    public class EpidotraMapBg_Menu : ModSurfaceBackgroundStyle
    {
        ...
        {
            return BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/EpidotraMapBg_Menu");
        }
        public override bool PreDrawCloseBackground(SpriteBatch spriteBatch)
        {
            ...
            int[] textureSlots = new int[] {
                BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/EpidotraMapBg_Menu"),
            };
