...
{
	public class RuinedKingdomSurfaceBgStyle : ModSurfaceBackgroundStyle
    {
        ...
        {
            return BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/RuinedKingdomSurfaceClose");
        }
        public override bool PreDrawCloseBackground(SpriteBatch spriteBatch)
        {
            ...
            int[] textureSlots = new int[] {
                BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/RuinedKingdomSurfaceFar"),
                BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/RuinedKingdomSurfaceMid"),
                BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/RuinedKingdomSurfaceClose"),
            };
