...
{
	public class WastelandCorruptBackgroundStyle : ModSurfaceBackgroundStyle
	{
		...
		{
			return BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/WastelandCorruptionBG2");
		}
		public override bool PreDrawCloseBackground(SpriteBatch spriteBatch)
		{
			...
			int[] textureSlots = new int[] {
				BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/WastelandCorruptionBG3"),
				BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/WastelandCorruptionBG3"),
				BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/WastelandCorruptionBG2"),
				BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/WastelandCorruptionBG1"),
			};
			...
			for (int i = 0; i < textureSlots.Length; i++)
			{
				...
				int bgTop = (int)((-Main.screenPosition.Y + screenOff / 2f) / (Main.worldSurface * 16.0) * a + b) + (int)scAdj - ((length - i) * 400);
				if (Main.gameMenu)
				{
					bgTop = 320;
				}
	...
	public class WastelandCrimsonBackgroundStyle : ModSurfaceBackgroundStyle
	{
		...
		public override int ChooseCloseTexture(ref float scale, ref double parallax, ref float a, ref float b)
		{
			return BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/WastelandCrimsonBG2");
		}
		public override bool PreDrawCloseBackground(SpriteBatch spriteBatch)
		{
			float a = 1100f;
			float b = 1750f;
			int[] textureSlots = new int[] {
				BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/WastelandCrimsonBG3"),
				BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/WastelandCrimsonBG3"),
				BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/WastelandCrimsonBG2"),
				BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/WastelandCrimsonBG1"),
			};
			int length = textureSlots.Length;
			for (int i = 0; i < textureSlots.Length; i++)
			{
