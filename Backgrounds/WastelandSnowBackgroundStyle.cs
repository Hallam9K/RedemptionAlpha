    ...
    public class WastelandSnowBackgroundStyle : ModSurfaceBackgroundStyle
    {
        ...
        public override bool PreDrawCloseBackground(SpriteBatch spriteBatch)
        {
            ...
            int[] textureSlots = new int[] {
                ...
                BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/WastelandSnowBG3"),
                BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/WastelandSnowBG2"),
                BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/WastelandSnowBG1"),
            };
