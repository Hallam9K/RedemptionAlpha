...
namespace Redemption.Backgrounds
{
    public class WastelandSurfaceBackgroundStyle : ModSurfaceBackgroundStyle
    {
        ...
        {
            return BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/PurityWastelandBG2");
        }
        public override bool PreDrawCloseBackground(SpriteBatch spriteBatch)
        {
            ...
            int[] textureSlots = new int[] {
                BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/PurityWastelandBG4"),
                BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/PurityWastelandBG3"),
                BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/PurityWastelandBG2"),
                BackgroundTextureLoader.GetBackgroundSlot("Redemption/Backgrounds/PurityWastelandBG1"),
            };
