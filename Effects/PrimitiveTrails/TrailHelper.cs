...
{
    public class TrailManager // Code by Boffin (From Spirit Mod)
    {
        ...
        public TrailManager(Mod mod)
        {
            ...
            _effect = mod.Assets.Request<Effect>("Effects/trailShaders", AssetRequestMode.ImmediateLoad).Value;
        ...
        {
            Trail newTrail = new(projectile, trailType, trailCap, trailPosition, shader ?? new DefaultShader(), widthAtFront, maxLength);
            newTrail.Update();
