...
namespace Redemption.Globals
{
    ...
    public sealed class ProjectileTags
    {
        ...
        public static void SetProjTags()
        {
            ...
            Psychic.SetMultiple(ProjectileID.BrainScramblerBolt, ProjectileID.MedusaHeadRay, ProjectileID.BookStaffShot, ModContent.ProjectileType<Cystling>());
