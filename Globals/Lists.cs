...
namespace Redemption.Globals
{
    ...
    public static class ItemLists
    {
        ...
        { ItemID.FieryGreatsword, ItemID.TheHorsemansBlade, ItemID.DD2SquireBetsySword, ItemID.MoltenPickaxe, ItemID.SolarFlarePickaxe, ItemID.MeteorHamaxe, ItemID.MoltenHamaxe, ItemID.LunarHamaxeSolar, ItemID.DD2PhoenixBow, ProjectileID.DD2FlameBurstTowerT1, ProjectileID.DD2FlameBurstTowerT2, ProjectileID.DD2FlameBurstTowerT3, ModContent.ItemType<DragonCleaver>(), ModContent.ItemType<Firebreak>() };

        public static List<int> Water = new()
        { ItemID.Muramasa, ItemID.PurpleClubberfish, ItemID.BloodRainBow };
        ...
        { ItemID.Seedler, ItemID.FossilPickaxe, ItemID.Picksaw, ItemID.AntlionClaw };
        ...
        { ItemID.Excalibur, ItemID.TrueExcalibur, ItemID.PickaxeAxe, ItemID.Pwnhammer, ItemID.Keybrand, ModContent.ItemType<Bindeklinge>(), ModContent.ItemType<BlindJustice>() };

        public static List<int> Shadow = new()
        { ItemID.LightsBane, ItemID.PurpleClubberfish, ItemID.NightsEdge, ItemID.TrueNightsEdge, ItemID.DeathSickle, ItemID.NightmarePickaxe, ItemID.WarAxeoftheNight, ItemID.TheBreaker, ItemID.OnyxBlaster };
        ...
        { ItemID.Starfury, ItemID.PiercingStarlight, ItemID.StarWrath, ItemID.Meowmere, ItemID.SolarFlarePickaxe, ItemID.NebulaPickaxe, ItemID.VortexPickaxe, ItemID.StardustPickaxe, ItemID.LunarHamaxeNebula, ItemID.LunarHamaxeSolar, ItemID.LunarHamaxeStardust, ItemID.LunarHamaxeVortex, ItemID.FairyQueenRangedItem };
