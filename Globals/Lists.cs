...
namespace Redemption.Globals
{
    ...
    public sealed class ProjectileTags
    {
        ...
        public static void SetProjTags()
        {
            ...
            Psychic.SetMultiple(ProjectileID.BrainScramblerBolt, ProjectileID.MedusaHeadRay, ProjectileID.BookStaffShot, ProjectileID.InsanityShadowHostile, ProjectileID.InsanityShadowFriendly, ModContent.ProjectileType<Cystling>(), ModContent.ProjectileType<Rockslide_Proj>(), ModContent.ProjectileType<Nanite_Proj>());
