...
namespace Redemption.Globals.NPC
{
    public class NPCPhysChain : GlobalNPC
    {
        ...
        /// The physchain.
        /// </summary>
        public IPhysChain[] npcPhysChain = new IPhysChain[maxChains];

        /// <summary>
        /// The positions of all segments of the chain
        /// </summary>
        public Vector3[][] bodyPhysChainPositions = new Vector3[maxChains][];

        public Vector2[] npcPhysChainOffset = new Vector2[maxChains];

        public int[] npcPhysChainDir = new int[maxChains];
