    ...
    public class RedeRecipe : ModSystem
    {
        ...
        public override void AddRecipes()
        {
            ...
            Recipe.Create(ItemID.LivingWoodWand)
                .AddIngredient(ItemType<LivingTwig>(), 32)
            ...
            Recipe.Create(ItemID.LivingLeafWall, 4)
                .AddIngredient(ItemType<LivingTwig>())
                .AddTile(TileID.WorkBenches)
                .Register();
            ...
            Recipe.Create(ItemID.LivingWoodDoor)
                .AddIngredient(ItemType<LivingTwig>(), 6)
                .AddTile(TileID.WorkBenches)
                .Register();
            ...
            Recipe.Create(ItemID.LivingWoodTable)
                .AddIngredient(ItemType<LivingTwig>(), 8)
                .AddTile(TileID.WorkBenches)
                .Register();
            Recipe.Create(ItemID.LivingWoodPiano)
                .AddIngredient(ItemType<LivingTwig>(), 15)
                .AddIngredient(ItemID.Bone, 4)
                .AddIngredient(ItemID.Book)
                .AddTile(TileID.WorkBenches)
                .Register();
            Recipe.Create(ItemID.LivingWoodBookcase)
                .AddIngredient(ItemType<LivingTwig>(), 20)
            ...
            Recipe.Create(ItemID.LivingWoodSofa)
                .AddIngredient(ItemType<LivingTwig>(), 5)
                .AddIngredient(ItemID.Silk, 2)
                .AddTile(TileID.WorkBenches)
                .Register();
            Recipe.Create(ItemID.LivingWoodBathtub)
                .AddIngredient(ItemType<LivingTwig>(), 14)
                .AddTile(TileID.WorkBenches)
                .Register();
            ...
            Recipe.Create(ItemID.LivingWoodLamp)
                .AddIngredient(ItemType<LivingTwig>(), 3)
                .AddIngredient(ItemID.Torch)
                .AddTile(TileID.WorkBenches)
                .Register();
            ...
            Recipe.Create(ItemID.LivingWoodWorkBench)
                .AddIngredient(ItemType<LivingTwig>(), 10)
                .AddTile(TileID.WorkBenches)
                .Register();
