...
namespace Redemption.Items.Accessories.HM
{
    public class HazmatSuit : ModItem
    {
        ...
        {
            if (equippedItem.type == ModContent.ItemType<HazmatSuit4>() || equippedItem.type == ModContent.ItemType<HazmatSuit2>() || equippedItem.type == ModContent.ItemType<HazmatSuit3>() || equippedItem.type == ModContent.ItemType<HEVSuit>())
                return false;
            return true;
        }
