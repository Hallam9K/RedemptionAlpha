...
{
    public class HazmatSuit4 : ModItem
    {
        ...
        {
            if (equippedItem.type == ModContent.ItemType<HazmatSuit>() || equippedItem.type == ModContent.ItemType<HazmatSuit2>() || equippedItem.type == ModContent.ItemType<HazmatSuit3>() || equippedItem.type == ModContent.ItemType<HEVSuit>())
                return false;
            return true;
        }
    ...
    public class HazmatSuit4Player : ModPlayer
    {
        ...
        public override void UpdateVisibleVanityAccessories()
        {
            for (int n = 13; n < 18 + Player.GetAmountOfExtraAccessorySlotsToShow(); n++)
            {
                ...
                if (item.type == ModContent.ItemType<HazmatSuit4>())
                {
                    HideVanity = false;
                    ForceVanity = true;
                }
        ...
        public override void FrameEffects()
        {
            ...
            {
                var hazmatCostume = ModContent.GetInstance<HazmatSuit4>();
