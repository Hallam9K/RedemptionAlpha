...
namespace Redemption.Items.Materials.PreHM
{
    public class MoonflareFragment : ModItem
    {
        ...
        public override bool PreDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, ref float rotation, ref float scale, int whoAmI)
        {
            ...
            Texture2D textureFaded = ModContent.Request<Texture2D>("Redemption/Items/Materials/PreHM/" + Item.ModItem.Texture + "_Faded").Value;
            Texture2D textureGlow = ModContent.Request<Texture2D>("Redemption/Items/Materials/PreHM/" + Item.ModItem.Texture + "_Glow").Value;
