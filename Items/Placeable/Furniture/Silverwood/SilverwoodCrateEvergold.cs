...
{
    public class SilverwoodCrateEvergold : ModItem
	{
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Silverwood Crate");
            Tooltip.SetDefault("Filled with evergold");
            SacrificeTotal = 1;
        }
        public override void SetDefaults()
        {
            Item.DefaultToPlaceableTile(ModContent.TileType<SilverwoodCratesTile>(), 1);
            Item.width = 28;
            Item.height = 30;
