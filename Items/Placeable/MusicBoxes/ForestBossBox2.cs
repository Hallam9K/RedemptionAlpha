...
namespace Redemption.Items.Placeable.MusicBoxes
{
    public class ForestBossBox2 : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            // Tooltip.SetDefault("Yuri O - Nature's Wrath");
            ItemID.Sets.CanGetPrefixes[Type] = false;
            ItemID.Sets.ShimmerTransformToItem[Type] = ItemID.MusicBox;
            Item.ResearchUnlockCount = 1;

            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Sounds/Music/BossUkkoAkka"), ModContent.ItemType<ForestBossBox2>(), ModContent.TileType<ForestBossBoxTile2>());
        }
