...
namespace Redemption.Items.Usable.Summons
{
    public class LabHologramDevice : ModItem
    {
        ...
        {
            Rectangle janitorRect = new((RedeGen.LabPoint.X + 145) * 16, (RedeGen.LabPoint.Y + 11) * 16, 47 * 16, 11 * 16);
            Rectangle behemothRect = new((RedeGen.LabPoint.X + 201) * 16, (RedeGen.LabPoint.Y + 45) * 16, 25 * 16, 76 * 16);
            Rectangle blisterfaceRect = new((RedeGen.LabPoint.X + 193) * 16, (RedeGen.LabPoint.Y + 163) * 16, 30 * 16, 20 * 16);
            Rectangle maceRect = new((RedeGen.LabPoint.X + 43) * 16, (RedeGen.LabPoint.Y + 153) * 16, 61 * 16, 29 * 16);
            Rectangle pzRect = new((RedeGen.LabPoint.X + 109) * 16, (RedeGen.LabPoint.Y + 170) * 16, 70 * 16, 42 * 16);
