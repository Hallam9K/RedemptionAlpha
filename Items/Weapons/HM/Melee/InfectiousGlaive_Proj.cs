...
namespace Redemption.Items.Weapons.HM.Melee
{
    public class InfectiousGlaive_Proj : ModProjectile, ITrailProjectile
    {
        ...
        {
            tManager.CreateTrail(Projectile, new GradientTrail(new Color(187, 241, 96), new Color(0, 98, 94)), new RoundCap(), new DefaultTrailPosition(), 100f, 250f, new ImageShader(Redemption.GlowTrail.Value, 0.01f, 1f, 1f));
        }
