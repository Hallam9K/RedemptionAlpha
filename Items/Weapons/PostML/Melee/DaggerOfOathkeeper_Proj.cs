...
namespace Redemption.Items.Weapons.PostML.Melee
{
                ...
                switch (Projectile.ai[0])
                {
                    ...
                    case 1:
                        ...
                        if (Timer >= 15 * SwingSpeed)
                        {
                            Projectile.Kill();
                            if (player.channel)
                                Projectile.Shoot(player.Center, ModContent.ProjectileType<DaggerOfOathkeeper_Proj2>(), Projectile.damage * 4, Projectile.velocity, false, SoundID.Item1);
                        }
                        break;
                }
            }
    ...
    public class DaggerOfOathkeeper_Proj2 : ModProjectile
    {
        ...
        public override bool PreAI()
        {
            ...
            if (Timer == 3)
                Projectile.Shoot(Projectile.Center, ModContent.ProjectileType<ShadeStab_Proj>(), Projectile.damage * 2, RedeHelper.PolarVector(26, vector.ToRotation()), false, SoundID.Item1, Main.rand.Next(2));
