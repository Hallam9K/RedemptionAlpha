...
namespace Redemption.Items.Weapons.PostML.Ranged
{
    public class XeniumElectrolaser_Proj : TrueMeleeProjectile
    {
        ...
        public override void AI()
        {
            ...
            Vector2 gunSmokePos = Projectile.Center + RedeHelper.PolarVector(35 * Projectile.spriteDirection, Projectile.rotation) + RedeHelper.PolarVector(-11, Projectile.rotation + MathHelper.PiOver2);
            offset -= 5;
            rotOffset += 0.1f;
            if (Main.myPlayer == Projectile.owner)
            {
