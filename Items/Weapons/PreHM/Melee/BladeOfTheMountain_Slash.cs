...
namespace Redemption.Items.Weapons.PreHM.Melee
{
    public class BladeOfTheMountain_Slash : TrueMeleeProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            RedeParticleManager.CreateSlashParticle(drawPos, dir.RotatedBy(Main.rand.NextFloat(-0.01f, 0.01f) + player.direction * MathHelper.PiOver4) * 100, 1f, Color.LightCyan, 8);
