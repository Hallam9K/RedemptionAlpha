...
namespace Redemption.Items.Weapons.PreHM.Summon
{
    public class CruxCardCalavia : ModItem
    {
        ...
        public override bool PreDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frame, Color drawColor, Color itemColor, Vector2 origin, float scale)
        {
            ...
            RedeDraw.DrawTreasureBagEffect(spriteBatch, bossTex, ref drawTimer, position - new Vector2(2, 2), new Rectangle(0, 0, bossTex.Width, bossTex.Height), RedeColor.EnergyPulse * .5f, 0, origin, scale, 0);
        ...
        public override bool PreDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, ref float rotation, ref float scale, int whoAmI)
        {
            ...
            RedeDraw.DrawTreasureBagEffect(spriteBatch, bossTex, ref drawTimer, Item.Center - new Vector2(2, 2) - Main.screenPosition, frame, RedeColor.EnergyPulse * .5f, rotation, origin, scale, 0);
