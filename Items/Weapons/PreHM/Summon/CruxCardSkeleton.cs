...
{
    public class CruxCardSkeleton : ModItem
    {
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            if (player.altFunctionUse == 2)
            {
                ...
                {
                    NPC npc = Main.npc[n];
                    if (!npc.active || npc.type != ModContent.NPCType<EpidotrianSkeleton_SS>())
                        continue;
        ...
        public override bool? UseItem(Player player)
        {
            if (player.whoAmI == Main.myPlayer)
            {
                ...
                if (player.altFunctionUse == 2)
                {
                    ...
                    {
                        NPC npc = Main.npc[n];
                        if (!npc.active || npc.type != ModContent.NPCType<EpidotrianSkeleton_SS>() || npc.ai[3] != player.whoAmI)
                            continue;
                ...
                else
                {
                    ...
                    int type = ModContent.NPCType<EpidotrianSkeleton_SS>();
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            {
                tooltips.Insert(tooltipLocation, new TooltipLine(Mod, "MaxLife", "108 base health"));
                tooltips.Insert(tooltipLocation + 2, new TooltipLine(Mod, "Defense", "7 defense"));
            }
        }
