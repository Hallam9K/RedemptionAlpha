...
{
    public class CruxCardSkeletonAssassin : ModItem
    {
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            if (player.altFunctionUse == 2)
            {
                ...
                {
                    NPC npc = Main.npc[n];
                    if (!npc.active || npc.type != ModContent.NPCType<SkeletonAssassin_SS>())
                        continue;
        ...
        public override bool? UseItem(Player player)
        {
            if (player.whoAmI == Main.myPlayer)
            {
                ...
                if (player.altFunctionUse == 2)
                {
                    ...
                    {
                        NPC npc = Main.npc[n];
                        if (!npc.active || npc.type != ModContent.NPCType<SkeletonAssassin_SS>() || npc.ai[3] != player.whoAmI)
                            continue;
                ...
                else
                {
                    ...
                    int type = ModContent.NPCType<SkeletonAssassin_SS>();
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            {
                tooltips.Insert(tooltipLocation, new TooltipLine(Mod, "MaxLife", "116 base health"));
