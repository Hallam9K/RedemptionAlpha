...
{
    public class CruxCardTied : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Crux Card: Asher");
            /* Tooltip.SetDefault("Summons the spirit of Asher\n" +
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            if (player.altFunctionUse == 2)
            {
                ...
                {
                    NPC npc = Main.npc[n];
                    if (!npc.active || npc.type != ModContent.NPCType<Asher_SS>())
                        continue;
        ...
        public override bool? UseItem(Player player)
        {
            if (player.whoAmI == Main.myPlayer)
            {
                ...
                if (player.altFunctionUse == 2)
                {
                    ...
                    {
                        NPC npc = Main.npc[n];
                        if (!npc.active || npc.type != ModContent.NPCType<Asher_SS>() || npc.ai[3] != player.whoAmI)
                            continue;
                ...
                else
                {
                    ...
                    int type = ModContent.NPCType<Asher_SS>();
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            {
                tooltips.Insert(tooltipLocation, new TooltipLine(Mod, "MaxLife", "418 base health"));
                tooltips.Insert(tooltipLocation + 2, new TooltipLine(Mod, "Defense", "10 defense"));
            }
        }
