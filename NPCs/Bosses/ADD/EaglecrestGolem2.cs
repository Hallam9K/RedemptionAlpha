                ...
                case ActionState.Transform:
                    ...
                    switch (TimerRand)
                    {
                        case 0:
                            ...
                            {
                                DustHelper.DrawParticleElectricity(eyePos, eyePos + RedeHelper.PolarVector(180, RedeHelper.RandomRotation()), 1f, 20, 0.1f, 1);
                                DustHelper.DrawParticleElectricity(eyePos, eyePos + RedeHelper.PolarVector(180, RedeHelper.RandomRotation()), 1f, 20, 0.1f, 1);
                            }
                            if (AITimer == 180)
                            {
                            ...
                            {
                                DustHelper.DrawParticleElectricity(eyePos, NPC.Center + RedeHelper.PolarVector(180, RedeHelper.RandomRotation()), 1f, 20, 0.1f, 1);
                                DustHelper.DrawParticleElectricity(eyePos, NPC.Center + RedeHelper.PolarVector(180, RedeHelper.RandomRotation()), 1f, 20, 0.1f, 1);
                            }
                        ...
                        case 1:
                            ...
                            if (AITimer >= 50)
                            {
                                ...
                                {
                                    DustHelper.DrawParticleElectricity(NPC.Center, NPC.Center + RedeHelper.PolarVector(50 + AITimer, RedeHelper.RandomRotation()), 2f, 20, 0.1f, 1);
                                    DustHelper.DrawParticleElectricity(NPC.Center, NPC.Center + RedeHelper.PolarVector(50 + AITimer, RedeHelper.RandomRotation()), 2f, 20, 0.1f, 1);
                                }
