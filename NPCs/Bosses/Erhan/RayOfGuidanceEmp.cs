...
{
    public class RayOfGuidanceEmp : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("Empowered Ray of Guidance");
        }
        ...
        public override void AI()
        {
            ...
            Projectile.MoveToVector2(player.Center + new Vector2(0, -800), 1.5f);
            ...
            if (AITimer >= 80)
            {
                Main.player[Main.myPlayer].GetModPlayer<ScreenPlayer>().ScreenShakeIntensity = 4;
                Projectile.alpha -= 10;
