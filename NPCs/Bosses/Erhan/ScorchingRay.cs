...
namespace Redemption.NPCs.Bosses.Erhan
{
    public class ScorchingRay : ModProjectile
    {
        ...
        public int LaserWidth = 38;
        public int LaserEndSegmentLength = 50;
        ...
        public void DrawLaser(Texture2D texture, Vector2 start, Vector2 unit, float rotation = 0f, float scale = 1f, float maxDist = 2000f, Color color = default, int transDist = 1)
        {
            ...
            for (float i = transDist; i <= (maxDist * (1 / LaserScale)); i += LaserSegmentLength)
            {
                ...
                Main.EntitySpriteDraw(texture, origin - Main.screenPosition + new Vector2(0, Projectile.gfxOffY),
                    new Rectangle((int)(128 * Frame), LaserEndSegmentLength, 128, LaserSegmentLength), color, r,
                    new Vector2(128 / 2, LaserSegmentLength / 2), scale, 0, 0);

                Main.EntitySpriteDraw(texture, origin - Main.screenPosition + new Vector2(0, Projectile.gfxOffY),
                    new Rectangle((int)(128 * Frame), LaserEndSegmentLength, 128, LaserSegmentLength), color * 0.5f, r,
                    new Vector2(128 / 2, LaserSegmentLength / 2), scale * new Vector2(pulse, 1), 0, 0);
            }
            ...
            Main.EntitySpriteDraw(texture, start + unit * (transDist - LaserEndSegmentLength) - Main.screenPosition + new Vector2(0, Projectile.gfxOffY),
                new Rectangle((int)(128 * Frame), 0, 128, LaserEndSegmentLength), color, r, new Vector2(128 / 2, LaserSegmentLength / 2), scale, 0, 0);
            // Draws the Laser 'end'
            Main.EntitySpriteDraw(texture, start + (maxDist * (1 / scale)) * unit - Main.screenPosition + new Vector2(0, Projectile.gfxOffY),
                new Rectangle((int)(128 * Frame), LaserSegmentLength + LaserEndSegmentLength, 128, LaserEndSegmentLength), color, r, new Vector2(128 / 2, LaserSegmentLength / 2), scale, 0, 0);

            // Draws the Laser 'base'
            Main.EntitySpriteDraw(texture, start + unit * (transDist - LaserEndSegmentLength) - Main.screenPosition + new Vector2(0, Projectile.gfxOffY),
                new Rectangle((int)(128 * Frame), 0, 128, LaserEndSegmentLength), color * 0.5f, r, new Vector2(128 / 2, LaserSegmentLength / 2), scale * new Vector2(pulse, 1), 0, 0);
            // Draws the Laser 'end'
            Main.EntitySpriteDraw(texture, start + (maxDist * (1 / scale)) * unit - Main.screenPosition + new Vector2(0, Projectile.gfxOffY),
                new Rectangle((int)(128 * Frame), LaserSegmentLength + LaserEndSegmentLength, 128, LaserEndSegmentLength), color * 0.5f, r, new Vector2(128 / 2, LaserSegmentLength / 2), scale * new Vector2(pulse, 1), 0, 0);
        }
