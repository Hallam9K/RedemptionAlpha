    ...
    public class SpaceKeeper : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            ...
            bestiaryEntry.Info.AddRange(new List<IBestiaryInfoElement> {
                ...
                new FlavorTextBestiaryInfoElement("The 3rd unit created by King Slayer III during his million year voyage. Construction began after an alien war which left most of Slayer's androids damaged or broken. This unit specialises in using nanobots to heal other robots.")
            });
        }
