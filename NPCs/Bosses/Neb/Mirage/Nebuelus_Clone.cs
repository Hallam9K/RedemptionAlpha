...
namespace Redemption.NPCs.Bosses.Neb.Clone
{
    ...
    public class Nebuleus_Clone : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            switch ((int)NPC.ai[0])
            {
                ...
                case 5:
                    switch (ID)
                    {
                        ...
                        case 0:
                            ...
                            {
                                NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y - 100), ModContent.ProjectileType<Shout1>(), 0, Vector2.Zero, false, SoundID.Item1 with { Volume = 0 }, "", NPC.whoAmI);
                            }
                        ...
                        case 1:
                            ...
                            if (NPC.ai[2] == 5 && phase < 1)
                            {
                                NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y - 100), ModContent.ProjectileType<Shout2>(), 0, Vector2.Zero, false, SoundID.Item1 with { Volume = 0 }, "", NPC.whoAmI);
                            }
                            ...
                            if (NPC.ai[2] >= 30 && NPC.ai[2] <= 70)
                            {
                                if (Main.rand.NextBool(2))
                                {
                                    ...
                                    NPC.Shoot(new Vector2(player.Center.X + A, player.Center.Y + B), ModContent.ProjectileType<Starfall_Tele>(), 120, new Vector2(NPC.spriteDirection != 1 ? -12f : 12f, 14f), false, SoundID.Item9 with { Volume = .5f });
                                }
                            }
                        ...
                        case 2:
                            ...
                            if (NPC.ai[2] == 5 && phase < 1)
                            {
                                NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y - 100), ModContent.ProjectileType<Shout3>(), 0, Vector2.Zero, false, SoundID.Item1 with { Volume = 0 }, "", NPC.whoAmI);
                            }
                            if (phase < 1)
                            {
                                ...
                                {
                                    NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y), ModContent.ProjectileType<PNebula1_Tele>(), 120, RedeHelper.PolarVector(18, (player.Center - NPC.Center).ToRotation()), false, SoundID.Item125 with { Volume = 0 }, "", NPC.whoAmI);
                                }
                            }
                            else if (phase == 1)
                            {
                            ...
                            else if (phase == 2)
                            {
                                ...
                                if (NPC.ai[2] == 30)
                                {
                                    NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y), ModContent.ProjectileType<PNebula1_Tele>(), 120, RedeHelper.PolarVector(18, (player.Center - NPC.Center).ToRotation() + 0.5f), false, SoundID.Item125 with { Volume = 0 }, "", NPC.whoAmI);
                                    NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y), ModContent.ProjectileType<PNebula1_Tele>(), 120, RedeHelper.PolarVector(18, (player.Center - NPC.Center).ToRotation() - 0.5f), false, SoundID.Item125 with { Volume = 0 }, "", NPC.whoAmI);
                                }
                                if (NPC.ai[2] == 60)
                                {
                                    NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y), ModContent.ProjectileType<PNebula1_Tele>(), 120, RedeHelper.PolarVector(18, (player.Center - NPC.Center).ToRotation()), false, SoundID.Item125 with { Volume = 0 }, "", NPC.whoAmI);
                                    NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y), ModContent.ProjectileType<PNebula1_Tele>(), 120, RedeHelper.PolarVector(18, (player.Center - NPC.Center).ToRotation() + 0.78f), false, SoundID.Item125 with { Volume = 0 }, "", NPC.whoAmI);
                                    NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y), ModContent.ProjectileType<PNebula1_Tele>(), 120, RedeHelper.PolarVector(18, (player.Center - NPC.Center).ToRotation() - 0.78f), false, SoundID.Item125 with { Volume = 0 }, "", NPC.whoAmI);
                                }
                            }
                            else
                            {
                                ...
                                {
                                    NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y), ModContent.ProjectileType<PNebula1_Tele>(), 120, RedeHelper.PolarVector(18, (player.Center - NPC.Center).ToRotation()), false, SoundID.Item125 with { Volume = 0 }, "", NPC.whoAmI);
                                    NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y), ModContent.ProjectileType<PNebula1_Tele>(), 120, RedeHelper.PolarVector(18, (player.Center - NPC.Center).ToRotation() + 1.2f), false, SoundID.Item125 with { Volume = 0 }, "", NPC.whoAmI);
                                    NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y), ModContent.ProjectileType<PNebula1_Tele>(), 120, RedeHelper.PolarVector(18, (player.Center - NPC.Center).ToRotation() - 1.2f), false, SoundID.Item125 with { Volume = 0 }, "", NPC.whoAmI);
                                    NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y), ModContent.ProjectileType<PNebula1_Tele>(), 120, RedeHelper.PolarVector(18, (player.Center - NPC.Center).ToRotation() + 0.6f), false, SoundID.Item125 with { Volume = 0 }, "", NPC.whoAmI);
                                    NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y), ModContent.ProjectileType<PNebula1_Tele>(), 120, RedeHelper.PolarVector(18, (player.Center - NPC.Center).ToRotation() - 0.6f), false, SoundID.Item125 with { Volume = 0 }, "", NPC.whoAmI);
                                }
                            }
                            if (NPC.ai[2] >= 120)
                        ...
                        case 3:
                            ...
                            {
                                NPC.Shoot(NPC.Center, ModContent.ProjectileType<NebTeleLine1>(), 0, NPC.DirectionTo(player.Center + player.velocity * 20f), false, SoundID.Item1 with { Volume = 0 }, "", phase > 1 ? 115 : 190, ai1: NPC.whoAmI);
                            }
                            if (NPC.ai[2] < 55)
                            {
                            ...
                            else if (NPC.ai[2] == 86)
                            {
                                ...
                                NPC.velocity = Vector2.Zero;
                                NPC.netUpdate = true;
                                if (repeat < 3) NPC.Shoot(NPC.Center, ModContent.ProjectileType<GiantStar_Proj>(), NPC.damage, Vector2.Zero, false, SoundID.Item1 with { Volume = 0 }, "", NPC.whoAmI);
                            }
                            if (NPC.ai[2] >= 90)
                            {
                                if (repeat <= 2)
                        ...
                        case 4:
                            ...
                            {
                                NPC.Shoot(new Vector2(player.Center.X, player.Center.Y + 350), ModContent.ProjectileType<Dash_Tele>(), 0, new Vector2(0, -6), false, SoundID.Item1 with { Volume = 0 });
                                for (int m = 0; m < 4; m++)
                                {
                        ...
                        case 5:
                            ...
                            {
                                NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y - 100), ModContent.ProjectileType<Shout9>(), 0, Vector2.Zero, false, SoundID.Item1 with { Volume = 0 }, "", NPC.whoAmI);
                            }
                        ...
                        case 6:
                            ...
                            if (NPC.ai[2] == 5)
                            {
                                if (phase < 3) { NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y - 100), ModContent.ProjectileType<Shout10>(), 0, Vector2.Zero, false, SoundID.Item1 with { Volume = 0 }, "", NPC.whoAmI); }
                                NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y), ModContent.ProjectileType<NebRing>(), 0, Vector2.Zero, false, SoundID.Item1 with { Volume = 0 }, "", NPC.whoAmI);
                            }
                            if (NPC.ai[2] == 20) { NPC.ai[3] = 8; }
                            if (NPC.ai[2] == 30)
                            {
                                NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y + 132), ModContent.ProjectileType<CosmicEye>(), 140, Vector2.Zero, true, SoundID.Item1, "NebSound1", NPC.whoAmI);
                                NPC.Shoot(new Vector2(NPC.Center.X - 67, NPC.Center.Y + 115), ModContent.ProjectileType<CosmicEye>(), 140, Vector2.Zero, true, SoundID.Item1, "NebSound1", NPC.whoAmI);
                                NPC.Shoot(new Vector2(NPC.Center.X + 67, NPC.Center.Y + 115), ModContent.ProjectileType<CosmicEye>(), 140, Vector2.Zero, true, SoundID.Item1, "NebSound1", NPC.whoAmI);
                            }
                            if (NPC.ai[2] == 60)
                            {
                                NPC.Shoot(new Vector2(NPC.Center.X - 115, NPC.Center.Y + 67), ModContent.ProjectileType<CosmicEye>(), 140, Vector2.Zero, true, SoundID.Item1, "NebSound1", NPC.whoAmI);
                                NPC.Shoot(new Vector2(NPC.Center.X + 115, NPC.Center.Y + 67), ModContent.ProjectileType<CosmicEye>(), 140, Vector2.Zero, true, SoundID.Item1, "NebSound1", NPC.whoAmI);
                                NPC.Shoot(new Vector2(NPC.Center.X - 132, NPC.Center.Y), ModContent.ProjectileType<CosmicEye>(), 140, Vector2.Zero, true, SoundID.Item1, "NebSound1", NPC.whoAmI);
                                NPC.Shoot(new Vector2(NPC.Center.X + 132, NPC.Center.Y), ModContent.ProjectileType<CosmicEye>(), 140, Vector2.Zero, true, SoundID.Item1, "NebSound1", NPC.whoAmI);
                                NPC.Shoot(new Vector2(NPC.Center.X - 115, NPC.Center.Y - 67), ModContent.ProjectileType<CosmicEye>(), 140, Vector2.Zero, true, SoundID.Item1, "NebSound1", NPC.whoAmI);
                                NPC.Shoot(new Vector2(NPC.Center.X + 115, NPC.Center.Y - 67), ModContent.ProjectileType<CosmicEye>(), 140, Vector2.Zero, true, SoundID.Item1, "NebSound1", NPC.whoAmI);
                            }
                        ...
                        case 8:
                            ...
                            {
                                NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y - 100), ModContent.ProjectileType<Shout8>(), 0, Vector2.Zero, false, SoundID.Item1 with { Volume = 0 }, "", NPC.whoAmI);
                            }
                            if (NPC.ai[2] == 10) { NPC.ai[3] = 3; }
                            if (NPC.ai[2] >= 40 && NPC.ai[2] < 120)
                            {
                                if (Main.rand.NextBool(4))
                                {
                                    ...
                                    NPC.Shoot(new Vector2(player.Center.X + A, player.Center.Y + B), ModContent.ProjectileType<Starfall_Tele>(), 120, new Vector2(NPC.spriteDirection != 1 ? -2f : 2f, 6f), false, SoundID.Item9 with { Volume = .5f });
                                }
                            }
                        ...
                        case 9:
                            ...
                            if (NPC.ai[2] == 5 && phase < 2)
                            {
                                NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y - 100), ModContent.ProjectileType<Shout5>(), 0, Vector2.Zero, false, SoundID.Item1 with { Volume = 0 }, "", NPC.whoAmI);
                            }
                            if (NPC.ai[2] == 10) { NPC.ai[3] = 1; }
                            if ((phase < 2 ? NPC.ai[2] % 5 == 0 : NPC.ai[2] % 3 == 0) && NPC.ai[2] >= 30 && NPC.ai[2] <= 60)
                            {
                                NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y), ModContent.ProjectileType<CurvingStar_Tele2>(), 120, new Vector2(Main.rand.Next(-7, 7), Main.rand.Next(-7, 7)), false, SoundID.Item9 with { Volume = 0 }, "", 1.01f);
                            }
                        ...
                        case 10:
                            ...
                            if (NPC.ai[2] == 5 && phase < 2)
                            {
                                NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y - 100), ModContent.ProjectileType<Shout6>(), 0, Vector2.Zero, false, SoundID.Item1 with { Volume = 0 }, "", NPC.whoAmI);
                            }
                        ...
                        case 11:
                            ...
                            {
                                NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y - 100), ModContent.ProjectileType<Shout11>(), 0, Vector2.Zero, false, SoundID.Item1 with { Volume = 0 }, "", NPC.whoAmI);
                            }
                            if (NPC.ai[2] == 10) { NPC.ai[3] = 3; }
                            if (NPC.ai[2] >= 40 && NPC.ai[2] < 120)
                            {
                                if (NPC.ai[2] % 15 == 0)
                                {
                                    ...
                                    NPC.Shoot(new Vector2(player.Center.X + A, player.Center.Y + B), ModContent.ProjectileType<CrystalStar_Tele>(), 120, new Vector2(NPC.spriteDirection != 1 ? -2f : 2f, 6f), false, SoundID.Item9 with { Volume = .5f });
                                }
                            }
                            if (NPC.ai[2] == 50) { NPC.ai[3] = 4; }
                            if (NPC.ai[2] >= 120)
                ...
                case 6:
                    ...
                    NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y), ModContent.ProjectileType<ShockwaveBoom>(), 0, Vector2.Zero, false, SoundID.Item1 with { Volume = 0 }, "", NPC.whoAmI);
                    NPC.netUpdate = true;
                    break;
                case 7:
                    NPC.LookAtEntity(player);
        ...
        public void Teleport(bool specialPos, Vector2 teleportPos)
        {
            ...
            if (!Main.dedServ)
                SoundEngine.PlaySound(new("Redemption/Sounds/Custom/Teleport1") { Volume = .5f, PitchVariance = .1f }, NPC.position);
            RazzleDazzle();
        }
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            Texture2D wings = ModContent.Request<Texture2D>("Redemption/NPCs/Bosses/Neb/Nebuleus_Wings").Value;
            Texture2D armsAni = ModContent.Request<Texture2D>("Redemption/NPCs/Bosses/Neb/Nebuleus_Arms_Idle").Value;
            Texture2D armsPrayAni = ModContent.Request<Texture2D>("Redemption/NPCs/Bosses/Neb/Nebuleus_Arms_Pray").Value;
            Texture2D armsPrayGlow = ModContent.Request<Texture2D>("Redemption/NPCs/Bosses/Neb/Nebuleus_Arms_Pray_Glow").Value;
            Texture2D armsStarfallAni = ModContent.Request<Texture2D>("Redemption/NPCs/Bosses/Neb/Nebuleus_Arms_Starfall").Value;
            Texture2D armsStarfallGlow = ModContent.Request<Texture2D>("Redemption/NPCs/Bosses/Neb/Nebuleus_Arms_Starfall_Glow").Value;
            Texture2D armsPiercingAni = ModContent.Request<Texture2D>("Redemption/NPCs/Bosses/Neb/Nebuleus_Arms_PiercingNebula").Value;
            Texture2D armsPiercingGlow = ModContent.Request<Texture2D>("Redemption/NPCs/Bosses/Neb/Nebuleus_Arms_PiercingNebula_Glow").Value;
            Texture2D armsChainAni = ModContent.Request<Texture2D>("Redemption/NPCs/Bosses/Neb/Nebuleus_Arms_CosmicChain").Value;
            Texture2D armsChainGlow = ModContent.Request<Texture2D>("Redemption/NPCs/Bosses/Neb/Nebuleus_Arms_CosmicChain_Glow").Value;
            Texture2D armsEyesAni = ModContent.Request<Texture2D>("Redemption/NPCs/Bosses/Neb/Nebuleus_Arms_LongCharge").Value;
            Texture2D armsEyesGlow = ModContent.Request<Texture2D>("Redemption/NPCs/Bosses/Neb/Nebuleus_Arms_LongCharge_Glow").Value;
            ...
            if (NPC.ai[3] != 6)
            {
                if (NPC.ai[3] == 0)
                {
                    ...
                    Main.spriteBatch.Draw(armsAni, drawCenter - screenPos, new Microsoft.Xna.Framework.Rectangle?(new Rectangle(0, y6, armsAni.Width, num214)), RedeColor.NebColour * ((255 - NPC.alpha) / 255f), NPC.rotation, new Vector2(armsAni.Width / 2f, num214 / 2f), NPC.scale, effects, 0f);
                }
                if (NPC.ai[3] == 1 || NPC.ai[3] == 2)
                {
                    int num214 = armsPrayAni.Height / 8;
                    int y6 = num214 * armFrames[1];
                    Main.spriteBatch.Draw(armsPrayAni, drawCenter - screenPos, new Microsoft.Xna.Framework.Rectangle?(new Rectangle(0, y6, armsPrayAni.Width, num214)), RedeColor.NebColour * ((255 - NPC.alpha) / 255f), NPC.rotation, new Vector2(armsPrayAni.Width / 2f, num214 / 2f), NPC.scale, effects, 0f);
                ...
                if (NPC.ai[3] == 3 || NPC.ai[3] == 4)
                {
                    ...
                    Main.spriteBatch.Draw(armsStarfallAni, drawCenter - screenPos, new Microsoft.Xna.Framework.Rectangle?(new Rectangle(0, y6, armsStarfallAni.Width, num214)), RedeColor.NebColour * ((255 - NPC.alpha) / 255f), NPC.rotation, new Vector2(armsStarfallAni.Width / 2f, num214 / 2f), NPC.scale, effects, 0f);
                ...
                if (NPC.ai[3] == 5)
                {
                    ...
                    Main.spriteBatch.Draw(armsPiercingAni, drawCenter - screenPos, new Microsoft.Xna.Framework.Rectangle?(new Rectangle(0, y6, armsPiercingAni.Width, num214)), RedeColor.NebColour * ((255 - NPC.alpha) / 255f), NPC.rotation, new Vector2(armsPiercingAni.Width / 2f, num214 / 2f), NPC.scale, effects, 0f);
                ...
                if (NPC.ai[3] == 7)
                {
                    ...
                    Main.spriteBatch.Draw(armsChainAni, drawCenter - screenPos, new Microsoft.Xna.Framework.Rectangle?(new Rectangle(0, y6, armsChainAni.Width, num214)), RedeColor.NebColour * ((255 - NPC.alpha) / 255f), NPC.rotation, new Vector2(armsChainAni.Width / 2f, num214 / 2f), NPC.scale, effects, 0f);
                    Main.spriteBatch.Draw(armsChainGlow, drawCenter - screenPos, new Microsoft.Xna.Framework.Rectangle?(new Rectangle(0, y6, armsChainAni.Width, num214)), NPC.GetAlpha(Color.White), NPC.rotation, new Vector2(armsChainAni.Width / 2f, num214 / 2f), NPC.scale, effects, 0f);
                }
                if (NPC.ai[3] == 8)
                {
                    int num214 = armsEyesAni.Height / 19;
                    int y6 = num214 * armFrames[5];
                    Main.spriteBatch.Draw(armsEyesAni, drawCenter - screenPos, new Microsoft.Xna.Framework.Rectangle?(new Rectangle(0, y6, armsEyesAni.Width, num214)), RedeColor.NebColour * ((255 - NPC.alpha) / 255f), NPC.rotation, new Vector2(armsEyesAni.Width / 2f, num214 / 2f), NPC.scale, effects, 0f);
                    Main.spriteBatch.Draw(armsEyesGlow, drawCenter - screenPos, new Microsoft.Xna.Framework.Rectangle?(new Rectangle(0, y6, armsEyesAni.Width, num214)), NPC.GetAlpha(Color.White), NPC.rotation, new Vector2(armsEyesAni.Width / 2f, num214 / 2f), NPC.scale, effects, 0f);
                }
            }
            spriteBatch.End();
