...
namespace Redemption.NPCs.Bosses.Neb.Clone
{
    ...
    public class Nebuleus2_Clone : ModNPC
    {
        ...
        public override void AI()
        {
                ...
                case 3:
                    switch (ID)
                    {
                        ...
                        case 0:
                            ...
                            if (NPC.ai[2] == 40 || NPC.ai[2] == 60)
                            {
                                if (Main.netMode != NetmodeID.MultiplayerClient)
                                {
                                    ...
                                    for (int m = 0; m < pieCut; m++)
                                    {
                                        int projID = Projectile.NewProjectile(NPC.GetSpawnSource_ForProjectile(), NPC.Center, Vector2.Zero, ModContent.ProjectileType<CurvingStar_Tele4>(), 120 / 3, 0, Main.myPlayer, 1.01f, 1);
                                        Main.projectile[projID].velocity = BaseUtility.RotateVector(default, new Vector2(5f, 0f), m / (float)pieCut * 6.28f);
                                        Main.projectile[projID].netUpdate = true;
                                    }
                                }
                        ...
                        case 1:
                            ...
                            if (NPC.ai[2] > 30 && (NPC.life <= (int)(NPC.lifeMax * .5f) ? NPC.ai[2] % 3 == 0 : NPC.ai[2] % 4 == 0) && NPC.ai[2] <= 140)
                            {
                                ...
                                if (Main.netMode != NetmodeID.MultiplayerClient)
                                {
                                    for (int i = 0; i < 4; i++)
                                    {
                                        Projectile.NewProjectile(NPC.GetSpawnSource_ForProjectile(), NPC.Center, new Vector2(6f, 0).RotatedBy(attackTimer[0] + Math.PI / 2 * i),
                        ...
                        case 2:
                            ...
                            if (NPC.ai[2] == 2)
                            {
                                NPC.Shoot(new Vector2(NPC.Center.X - 900, NPC.Center.Y - 900), ModContent.ProjectileType<CosmicEye2>(), 150, new Vector2(0, 10), true, SoundID.Item1, "Sounds/Custom/NebSound1", NPC.whoAmI);
                                NPC.Shoot(new Vector2(NPC.Center.X - 900, NPC.Center.Y + 900), ModContent.ProjectileType<CosmicEye2>(), 150, new Vector2(10, 0), true, SoundID.Item1, "Sounds/Custom/NebSound1", NPC.whoAmI);
                                NPC.Shoot(new Vector2(NPC.Center.X + 900, NPC.Center.Y + 900), ModContent.ProjectileType<CosmicEye2>(), 150, new Vector2(0, -10), true, SoundID.Item1, "Sounds/Custom/NebSound1", NPC.whoAmI);
                                NPC.Shoot(new Vector2(NPC.Center.X + 900, NPC.Center.Y - 900), ModContent.ProjectileType<CosmicEye2>(), 150, new Vector2(-10, 0), true, SoundID.Item1, "Sounds/Custom/NebSound1", NPC.whoAmI);
                            }
                            if (NPC.ai[2] == 30)
                            {
                                if (Main.netMode != NetmodeID.MultiplayerClient)
                                {
                                    ...
                                    for (int m = 0; m < pieCut; m++)
                                    {
                                        int projID = Projectile.NewProjectile(NPC.GetSpawnSource_ForProjectile(), NPC.Center, Vector2.Zero, ModContent.ProjectileType<CurvingStar_Tele4>(), 120 / 3, 0, Main.myPlayer, 1.001f, 2);
                                        Main.projectile[projID].velocity = BaseUtility.RotateVector(default, new Vector2(5f, 0f), m / (float)pieCut * 6.28f);
                                        Main.projectile[projID].netUpdate = true;
                                    }
                                    for (int m = 0; m < pieCut; m++)
                                    {
                                        int projID = Projectile.NewProjectile(NPC.GetSpawnSource_ForProjectile(), NPC.Center, Vector2.Zero, ModContent.ProjectileType<CurvingStar_Tele4>(), 120 / 3, 0, Main.myPlayer, 1.001f, 3);
                                        Main.projectile[projID].velocity = BaseUtility.RotateVector(default, new Vector2(5f, 0f), m / (float)pieCut * 6.28f);
                                        Main.projectile[projID].netUpdate = true;
                                    }
                                }
                        ...
                        case 3:
                            ...
                            if (NPC.ai[2] >= 30 && NPC.ai[2] <= 70)
                            {
                                if (Main.rand.Next(2) == 0)
                                {
                                    ...
                                    NPC.Shoot(new Vector2(player.Center.X + A, player.Center.Y + B), ModContent.ProjectileType<Starfall_Tele2>(), 120, new Vector2(NPC.spriteDirection != 1 ? -12f : 12f, 14f), false, SoundID.Item9.WithVolume(0.5f));
                                }
                            }
                        ...
                        case 4:
                            ...
                            if (NPC.ai[2] > 30 && NPC.ai[2] % 3 == 0 && NPC.ai[2] <= 180)
                            {
                                ...
                                if (Main.netMode != NetmodeID.MultiplayerClient)
                                {
                                    Projectile.NewProjectile(NPC.GetSpawnSource_ForProjectile(), NPC.Center, new Vector2(6f, 0).RotatedBy(attackTimer[0] + Math.PI / 2),
                            ...
                            if (NPC.ai[2] == 40 || NPC.ai[2] == 120)
                            {
                                if (Main.netMode != NetmodeID.MultiplayerClient)
                                {
                                    ...
                                    for (int m = 0; m < pieCut; m++)
                                    {
                                        int projID = Projectile.NewProjectile(NPC.GetSpawnSource_ForProjectile(), NPC.Center, Vector2.Zero, ModContent.ProjectileType<CurvingStar_Tele4>(), 120 / 3, 0, Main.myPlayer, 1.001f, 0);
                        ...
                        case 5:
                            ...
                            if (NPC.ai[2] == 30)
                            {
                                if (Main.netMode != NetmodeID.MultiplayerClient)
                                {
                                    for (int k = 0; k < 16; k++)
                                    {
                                        ...
                                        NPC.Shoot(new Vector2((int)NPC.Center.X + (int)vector.X, (int)NPC.Center.Y + (int)vector.Y), ModContent.ProjectileType<CosmicEye>(), 140, Vector2.Zero, true, SoundID.Item1, "Sounds/Custom/NebSound1", NPC.whoAmI);
                                    }
                                }
                            }
                            ...
                            if (NPC.ai[2] == 130 || NPC.ai[2] == 150)
                            {
                                if (Main.netMode != NetmodeID.MultiplayerClient)
                                {
                                    ...
                                    for (int m = 0; m < pieCut; m++)
                                    {
                                        int projID = Projectile.NewProjectile(NPC.GetSpawnSource_ForProjectile(), NPC.Center, Vector2.Zero, ModContent.ProjectileType<CurvingStar_Tele4>(), 120 / 3, 0, Main.myPlayer, 1.02f, 0);
                                        Main.projectile[projID].velocity = BaseUtility.RotateVector(default, new Vector2(5f, 0f), m / (float)pieCut * 6.28f);
                                        Main.projectile[projID].netUpdate = true;
                                    }
                                }
                            ...
                            if (NPC.ai[2] == 140 || NPC.ai[2] == 160)
                            {
                                if (Main.netMode != NetmodeID.MultiplayerClient)
                                {
                                    ...
                                    for (int m = 0; m < pieCut; m++)
                                    {
                                        int projID = Projectile.NewProjectile(NPC.GetSpawnSource_ForProjectile(), NPC.Center, Vector2.Zero, ModContent.ProjectileType<CurvingStar_Tele4>(), 120 / 3, 0, Main.myPlayer, 1.02f, 1);
                                        Main.projectile[projID].velocity = BaseUtility.RotateVector(default, new Vector2(5f, 0f), m / (float)pieCut * 6.28f);
                                        Main.projectile[projID].netUpdate = true;
                                    }
                                }
                        ...
                        case 7:
                            ...
                            if (NPC.ai[2] >= 40 && NPC.ai[2] < 120)
                            {
                                if (Main.rand.Next(4) == 0)
                                {
                                    ...
                                    NPC.Shoot(new Vector2(player.Center.X + A, player.Center.Y + B), ModContent.ProjectileType<Starfall_Tele2>(), 120, new Vector2(NPC.spriteDirection != 1 ? -2f : 2f, 6f), false, SoundID.Item9.WithVolume(0.5f));
                                }
                            }
                        ...
                        case 8:
                            ...
                            {
                                NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y), ModContent.ProjectileType<CurvingStar_Tele4>(), 120, new Vector2(Main.rand.Next(-7, 7), Main.rand.Next(-7, 7)), false, SoundID.Item9.WithVolume(0f), "", 1.01f);
                            }
                        ...
                        case 11:
                            ...
                            if (NPC.ai[2] == 25)
                            {
                                NPC.Shoot(NPC.Center, ModContent.ProjectileType<NebTeleLine1>(), 0, NPC.DirectionTo(player.Center + player.velocity * 20f), false, SoundID.Item1.WithVolume(0), "", 115, ai1: NPC.whoAmI);
                            }
                            if (NPC.ai[2] < 55)
                            {
                            ...
                            {
                                NPC.Shoot(NPC.Center, ModContent.ProjectileType<StarBolt>(), 120, RedeHelper.PolarVector(3, NPC.rotation + MathHelper.PiOver2), false, SoundID.Item91);
                                NPC.Shoot(NPC.Center, ModContent.ProjectileType<StarBolt>(), 120, RedeHelper.PolarVector(3, NPC.rotation - MathHelper.PiOver2), false, SoundID.Item91);
                            }
                            if (NPC.ai[2] >= 90)
                            {
                        ...
                        case 12:
                            ...
                            {
                                NPC.Shoot(new Vector2(player.Center.X, player.Center.Y + 350), ModContent.ProjectileType<Dash_Tele2>(), 0, new Vector2(0, -6), false, SoundID.Item1.WithVolume(0));
                                for (int m = 0; m < 4; m++)
                                {
                            ...
                            {
                                NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y), ModContent.ProjectileType<PNebula1_Tele>(), 120, RedeHelper.PolarVector(18, (player.Center - NPC.Center).ToRotation()), false, SoundID.Item125.WithVolume(0), "", NPC.whoAmI);
                            }
                            if (NPC.ai[2] > 95)
                            {
                                NPC.velocity *= 0.94f;
                        ...
                        case 15:
                            ...
                            {
                                NPC.Shoot(NPC.Center, ModContent.ProjectileType<StarBolt>(), 120, NPC.velocity.RotatedBy(Math.PI / 2) / 20, false, SoundID.Item117);
                                NPC.Shoot(NPC.Center, ModContent.ProjectileType<StarBolt>(), 120, NPC.velocity.RotatedBy(-Math.PI / 2) / 20, false, SoundID.Item117);
                            }
                            if (NPC.velocity.Length() < 10)
                            {
                        ...
                        case 16:
                            ...
                            if (NPC.ai[2] > 30 && NPC.ai[2] <= 300)
                            {
                                ...
                                if (Main.netMode != NetmodeID.MultiplayerClient)
                                {
                                    Projectile.NewProjectile(NPC.GetSpawnSource_ForProjectile(), NPC.Center, new Vector2(2f, 0).RotatedBy(attackTimer[0] + Math.PI / 2),
                        ...
                        case 17:
                            ...
                            {
                                if (!Main.dedServ)
                                    SoundEngine.PlaySound(SoundLoader.GetLegacySoundSlot(Mod, "Sounds/Custom/NebSound2").WithPitchVariance(0.1f), (int)NPC.position.X, (int)NPC.position.Y);
                            }
                            if (NPC.ai[2] >= 80)
                            {
                                if (NPC.ai[3] != 6) { NPC.LookAtEntity(player); NPC.netUpdate = true; }
                                ...
                                if (NPC.ai[2] > 85 && NPC.ai[2] % 3 == 0)
                                {
                                    if (Main.netMode != NetmodeID.MultiplayerClient)
                                    {
                                        int p = Projectile.NewProjectile(NPC.GetSpawnSource_ForProjectile(), NPC.Center, RedeHelper.PolarVector(2, (vector - NPC.Center).ToRotation()), ModContent.ProjectileType<StarBolt>(), 150 / 3, 0, Main.myPlayer, NPC.whoAmI);
            ...
            #region Teleporting
            if (Vector2.Distance(NPC.Center, player.Center) >= 950 && NPC.ai[0] > 0 && NPC.ai[1] != 2 && NPC.ai[1] != 4 && NPC.ai[1] != 5 && NPC.ai[1] != 10 && NPC.ai[1] != 11 && NPC.ai[1] != 12 && NPC.ai[1] != 15 && NPC.ai[1] != 17)
            {
                Teleport(false, Vector2.Zero);
            }
            #endregion
        ...
        public void Teleport(bool specialPos, Vector2 teleportPos)
        {
            ...
            teleVector = NPC.Center;
            if (!Main.dedServ)
                SoundEngine.PlaySound(SoundLoader.GetLegacySoundSlot(Mod, "Sounds/Custom/Teleport2").WithPitchVariance(0.1f), (int)NPC.position.X, (int)NPC.position.Y);
        ...
        public void RazzleDazzle()
        {
            if (Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                for (int m = 0; m < pieCut; m++)
                {
                    int dustID = Dust.NewDust(new Vector2(NPC.Center.X - 1, NPC.Center.Y - 1), 2, 2, dustType, 0f, 0f, 100, Color.White, 4f);
                    Main.dust[dustID].velocity = BaseUtility.RotateVector(default, new Vector2(10f, 0f), m / (float)pieCut * 6.28f);
                    Main.dust[dustID].noLight = false;
                    Main.dust[dustID].noGravity = true;
                }
                int dustType2 = 59;
                ...
                {
                    int dustID = Dust.NewDust(new Vector2(NPC.Center.X - 1, NPC.Center.Y - 1), 2, 2, dustType2, 0f, 0f, 100, Color.White, 4f);
                    Main.dust[dustID].velocity = BaseUtility.RotateVector(default, new Vector2(12f, 0f), m / (float)pieCut2 * 6.28f);
                    Main.dust[dustID].noLight = false;
                    Main.dust[dustID].noGravity = true;
                }
                int dustType3 = 60;
                ...
                {
                    int dustID = Dust.NewDust(new Vector2(NPC.Center.X - 1, NPC.Center.Y - 1), 2, 2, dustType3, 0f, 0f, 100, Color.White, 4f);
                    Main.dust[dustID].velocity = BaseUtility.RotateVector(default, new Vector2(14f, 0f), m / (float)pieCut3 * 6.28f);
                    Main.dust[dustID].noLight = false;
                    Main.dust[dustID].noGravity = true;
                }
                int dustType4 = 62;
                ...
                {
                    int dustID = Dust.NewDust(new Vector2(NPC.Center.X - 1, NPC.Center.Y - 1), 2, 2, dustType4, 0f, 0f, 100, Color.White, 4f);
                    Main.dust[dustID].velocity = BaseUtility.RotateVector(default, new Vector2(16f, 0f), m / (float)pieCut4 * 6.28f);
                    Main.dust[dustID].noLight = false;
                    Main.dust[dustID].noGravity = true;
                }
            }
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            Texture2D wings = ModContent.Request<Texture2D>("Redemption/NPCs/Bosses/Neb/Phase2/Nebuleus2_Wings").Value;
            Texture2D armsAni = ModContent.Request<Texture2D>("Redemption/NPCs/Bosses/Neb/Phase2/Nebuleus2_Arms_Idle").Value;
            Texture2D armsPrayAni = ModContent.Request<Texture2D>("Redemption/NPCs/Bosses/Neb/Phase2/Nebuleus2_Pray").Value;
            Texture2D armsPrayGlow = ModContent.Request<Texture2D>("Redemption/NPCs/Bosses/Neb/Phase2/Nebuleus2_Pray_Glow").Value;
            Texture2D armsStarfallAni = ModContent.Request<Texture2D>("Redemption/NPCs/Bosses/Neb/Phase2/Nebuleus2_Starfall").Value;
            Texture2D armsStarfallGlow = ModContent.Request<Texture2D>("Redemption/NPCs/Bosses/Neb/Phase2/Nebuleus2_Starfall_Glow").Value;
            Texture2D armsEyesAni = ModContent.Request<Texture2D>("Redemption/NPCs/Bosses/Neb/Phase2/Nebuleus2_Punch").Value;
            Texture2D armsPiercingAni = ModContent.Request<Texture2D>("Redemption/NPCs/Bosses/Neb/Phase2/Nebuleus2_Arms_PiercingNebula").Value;
            Texture2D armsPiercingGlow = ModContent.Request<Texture2D>("Redemption/NPCs/Bosses/Neb/Phase2/Nebuleus2_Arms_PiercingNebula_Glow").Value;
