                ...
                case 3:
                    switch (ID)
                    {
                        ...
                        case 8:
                            ...
                            {
                                NPC.Shoot(new Vector2(NPC.Center.X, NPC.Center.Y), ModContent.ProjectileType<CurvingStar_Tele4>(), (int)(NPC.damage * .67f), new Vector2(Main.rand.Next(-7, 7), Main.rand.Next(-7, 7)), SoundID.Item9, 1.01f);
                            }
