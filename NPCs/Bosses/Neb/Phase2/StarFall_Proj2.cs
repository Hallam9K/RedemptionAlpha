...
{
    public class StarFall_Proj2 : ModProjectile, ITrailProjectile
    {
    ...
    public class Starfall_Tele2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (AITimer == 0)
            {
                ...
                {
                    Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center, Projectile.velocity, ProjectileType<StarFall_Proj2>(), Projectile.damage, Projectile.knockBack, Main.myPlayer);
                }
            }
