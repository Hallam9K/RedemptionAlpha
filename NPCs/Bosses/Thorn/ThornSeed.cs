...
namespace Redemption.NPCs.Bosses.Thorn
{
    public class ThornSeed : ModProjectile
    {
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.InheritSource(Projectile), new Vector2(Projectile.Center.X, Projectile.Center.Y - 36), Vector2.Zero, ModContent.ProjectileType<ThornTrap>(), Projectile.damage, 3, Projectile.owner);
            }
            return true;
        }
    }
