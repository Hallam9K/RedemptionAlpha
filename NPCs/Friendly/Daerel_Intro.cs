            ...
            switch (TimerRand)
            {
                case 0:
                    if (AITimer++ == 0)
                    {
                        ...
                        RedeSystem.Instance.DialogueUIElement.DisplayDialogue("Woah!", 200, 1, 0.5f, "Daerel:", 0, null, null, NPC.Center + new Vector2(0, -80) - Main.screenPosition, null, 0, sound: true);
                    }
                    NPC.rotation += 0.1f;
                ...
                case 2:
                    if (AITimer++ == 40)
                    {
                        ...
                        RedeSystem.Instance.DialogueUIElement.DisplayDialogue("Ow, my head hurts..", 180, 1, 0.5f, "Daerel:", 0.2f, null, null, NPC.Center + new Vector2(0, -80) - Main.screenPosition, null, 0, sound: true);
                    }
                    if (AITimer >= 220)
                    {
                        ExtraFrames = 0;
                ...
                case 3:
                    if (AITimer++ == 5)
                        RedeSystem.Instance.DialogueUIElement.DisplayDialogue("Hey Zephos, do you know where we are?", 185, 1, 0.5f, "Daerel:", 0.2f, null, null, NPC.Center + new Vector2(0, -80) - Main.screenPosition, null, 0, sound: true);
                    if (AITimer >= 190 && AITimer % 30 == 0 && AITimer < 330)
                        NPC.spriteDirection *= -1;
                    if (AITimer == 190)
                    {
                        EmoteBubble.NewBubble(87, new WorldUIAnchor(NPC), 140);
                        RedeSystem.Instance.DialogueUIElement.DisplayDialogue("Uh.. Zephos?", 140, 1, 0.5f, "Daerel:", 0.2f, null, null, NPC.Center + new Vector2(0, -80) - Main.screenPosition, null, 0, sound: true);
                    }
                    if (AITimer >= 330)
                    ...
                    if (AITimer == 330)
                    {
                        ...
                        NPC.velocity.Y = -3;
                        RedeSystem.Instance.DialogueUIElement.DisplayDialogue("Oh, hi there! Didn't notice you.", 180, 1, 0.5f, "Daerel:", 0.2f, null, null, NPC.Center + new Vector2(0, -80) - Main.screenPosition, null, 0, sound: true);
                    }
                    if (AITimer == 510)
                        RedeSystem.Instance.DialogueUIElement.DisplayDialogue("You haven't seen my friend around here, have you?", 240, 1, 0.5f, "Daerel:", 0.2f, null, null, NPC.Center + new Vector2(0, -80) - Main.screenPosition, null, 0, sound: true);
                    if (AITimer == 750)
                        RedeSystem.Instance.DialogueUIElement.DisplayDialogue("Guess he didn't jump in. Oh well, I'll head back to get him.", 240, 1, 0.5f, "Daerel:", 0.2f, null, null, NPC.Center + new Vector2(0, -80) - Main.screenPosition, null, 0, sound: true);
                    if (AITimer == 990)
                        RedeSystem.Instance.DialogueUIElement.DisplayDialogue("I'll come back once I find him, so, see you soon I guess.", 200, 1, 0.5f, "Daerel:", 0.2f, null, null, NPC.Center + new Vector2(0, -80) - Main.screenPosition, null, 0, sound: true);
                    if (AITimer == 1140)
                    {
                        NPC.velocity.Y = -8;
                        NPC.velocity.X = -3;
