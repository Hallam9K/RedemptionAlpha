    ...
    public class SpiritAssassin : ModNPC
    {
        ...
        public static string ChitChat()
        {
            ...
            return ChatNumber switch
            {
                ...
                1 => "I would have it guessed you've been on this island and only this island, hm? Gathuram is one of the six domains of the mainland - one of the largest, too. In terms of landmass, anyway. I've seldom been beyond the outer fields of Gothrione in my time of living, neither have I in my time of unliving, so I cannot speak to you of it in detail.",
