    ...
    public class SpiritCommonGuard : ModNPC
    {
        ...
        public static string ChitChat()
        {
            return ChatNumber switch
            {
                ...
                1 => "By Grace! To think anyone who walks this earth be unaware of the greatest domain in Epidotra would be absurd! The Hallowed Dominion is where I'm from, and Ricusa City is where I resided. 'Tis a peaceful and prosperous land, home to great cities and castles and all the protection thou canst get! Well, sort of.",
