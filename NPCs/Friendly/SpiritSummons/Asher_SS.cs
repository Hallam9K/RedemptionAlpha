        ...
        public override void AI()
        {
            ...
            switch (AIState)
            {
                ...
                case ActionState.Alert:
                    ...
                    NPCHelper.HorizontallyMove(NPC, globalNPC.attacker.Center, 0.2f, 4.2f * SpeedMultiplier * (NPC.RedemptionNPCBuff().rallied ? 1.2f : 1),
                ...
                case ActionState.Attack:
                    ...
                    if ((AniFrameY == 3 && globalNPC.attacker.Hitbox.Intersects(SlashHitbox1)) || (AniFrameY == 6 && globalNPC.attacker.Hitbox.Intersects(SlashHitbox2)))
                    {
                        ...
                        {
                            attackerNPC.immune[NPC.whoAmI] = 6;
