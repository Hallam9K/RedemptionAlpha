        ...
        public override void AI()
        {
            ...
            switch (AIState)
            {
                ...
                case ActionState.Alert:
                    ...
                    NPCHelper.HorizontallyMove(NPC, globalNPC.attacker.Center, 0.15f, 2.2f * (NPC.RedemptionNPCBuff().rallied ? 1.2f : 1), 12, 8, NPC.Center.Y > globalNPC.attacker.Center.Y);
