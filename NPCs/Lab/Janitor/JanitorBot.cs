...
namespace Redemption.NPCs.Lab.Janitor
{
    ...
    public class JanitorBot : ModNPC
    {
        ...
        {
            if (AIState is not ActionState.Slip && !NPC.GetGlobalNPC<GuardNPC>().IgnoreArmour && !NPC.HasBuff(BuffID.BrokenArmor) && NPC.GetGlobalNPC<GuardNPC>().GuardPoints >= 0)
            {
        ...
        public override void OnKill()
        {
            ...
            RedeHelper.SpawnNPC((int)NPC.Center.X, (int)NPC.Center.Y, ModContent.NPCType<JanitorBot_Defeated>());
