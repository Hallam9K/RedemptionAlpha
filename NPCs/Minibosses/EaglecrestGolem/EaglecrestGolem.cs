                    ...
                    switch (TimerRand)
                    {
                        ...
                        case 1:
                            ...
                            if (AITimer >= .25f && AITimer < .5f && Main.rand.NextBool(6))
                            {
                                ...
                                DustHelper.DrawParticleElectricity(origin, NPC.Center + RedeHelper.PolarVector(180, RedeHelper.RandomRotation()), 1f, 20, 0.1f, 1);
                                DustHelper.DrawParticleElectricity(origin, NPC.Center + RedeHelper.PolarVector(180, RedeHelper.RandomRotation()), 1f, 20, 0.1f, 1);
                            }
                            if (glowOpacity >= 0.9f)
                            {
                        ...
                        case 1:
                            ...
                            if (AITimer-- <= 0 && BaseAI.HitTileOnSide(NPC, 3, false, NPC.Center.Y + 28 > player.Center.Y) && !Collision.SolidCollision(NPC.Center - Vector2.One, 2, 2) && glowOpacity < 1)
                            {
                                ...
                                if (NPC.life <= NPC.lifeMax / 4)
                                {
                                    ...
                                    for (int i = 0; i < 3; i++)
                                        DustHelper.DrawParticleElectricity(NPC.Center - new Vector2(0, 400), NPC.Center, 2f, 30, 0.1f, 1);
