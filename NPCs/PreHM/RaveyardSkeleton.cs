...
namespace Redemption.NPCs.PreHM
{
    public class RaveyardSkeleton : SkeletonBase
    {
        ...
        {
            if (HasEyes)
                RedeHelper.SpawnNPC((int)NPC.Center.X, (int)NPC.Center.Y, ModContent.NPCType<LostSoulNPC>(), Main.rand.NextFloat(0, 0.5f));
            else if (Main.rand.NextBool(7))
                RedeHelper.SpawnNPC((int)NPC.Center.X, (int)NPC.Center.Y, ModContent.NPCType<LostSoulNPC>(), Main.rand.NextFloat(0, 0.3f));
        }
