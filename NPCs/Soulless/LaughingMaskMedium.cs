...
{
    public class LaughingMaskMedium : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            {
                if (!Main.dedServ)
                    SoundEngine.PlaySound(SoundLoader.GetLegacySoundSlot(Mod, "Sounds/Custom/MaskLaugh2").WithVolume(.5f).WithPitchVariance(0.1f));
