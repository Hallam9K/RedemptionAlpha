        ...
        public override void AI()
        {
            ...
            switch (AIState)
            {
                ...
                case ActionState.Alert:
                    ...
                    NPCHelper.HorizontallyMove(NPC, globalNPC.attacker.Center, 0.2f, 3f * SpeedMultiplier, 12, 12, NPC.Center.Y > globalNPC.attacker.Center.Y, globalNPC.attacker);
                    break;
                    ...
                    if (++NPC.frameCounter >= 3)
                    {
                        ...
                        if (AniFrameY is 6 or 10)
                        {
                            ...
                            if (powerUp)
                            {
                                int damage = NPC.RedemptionNPCBuff().disarmed ? NPC.damage / 3 : NPC.damage;
                                if (AniFrameY is 6)
                                    NPC.Shoot(NPC.Center, ModContent.ProjectileType<SoullessDuelist_Slash_Proj>(), damage, new Vector2(20 * NPC.spriteDirection, 0), SoundID.DD2_PhantomPhoenixShot, NPC.whoAmI);
                                if (AniFrameY is 10)
                                    NPC.Shoot(NPC.Center, ModContent.ProjectileType<SoullessDuelist_Slash_Proj2>(), (int)(damage * 1.2f), new Vector2(30 * NPC.spriteDirection, 0), SoundID.DD2_PhantomPhoenixShot, NPC.whoAmI);
                            }
                        }
                        if (AniFrameY > 14)
                        {
