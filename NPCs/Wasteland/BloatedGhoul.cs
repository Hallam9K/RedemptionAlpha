...
{
    public class BloatedGhoul : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            Banner = NPC.type;
            BannerItem = ModContent.ItemType<BloatedGhoulBanner>();
        }
        ...
        public override void AI()
        {
            ...
            switch (AIState)
            {
                ...
                case ActionState.Wander:
                    ...
                    RedeHelper.HorizontallyMove(NPC, moveTo * 16, 0.4f, 1.3f, 16, 10, NPC.Center.Y > player.Center.Y);
                    break;
                ...
                case ActionState.Alert:
                    ...
                    if (Main.rand.NextBool(2) && NPC.velocity.Y == 0 && NPC.Sight(globalNPC.attacker, 120, false, true))
                    {
                        NPC.velocity.X *= 0f;
                        AITimer = 0;
                        AIState = ActionState.Explode;
                        return;
                    }
                    ...
                    NPC.PlatformFallCheck(ref NPC.Redemption().fallDownPlatform, 20);
                    RedeHelper.HorizontallyMove(NPC, globalNPC.attacker.Center, 0.17f, 4.5f * (NPC.RedemptionNPCBuff().rallied ? 1.2f : 1), 16, 10, NPC.Center.Y > globalNPC.attacker.Center.Y);
                    break;
                ...
                case ActionState.Explode:
                    ...
                    if (AITimer >= 40)
                    {
                        ...
                        for (int i = 0; i < 30; i++)
                        {
                            int dustIndex = Dust.NewDust(NPC.position, NPC.width, NPC.height, DustID.GreenBlood, newColor: Color.DarkGreen, Scale: 2f);
        ...
        {
            if (AIState is ActionState.Explode)
            {
                NPC.rotation = 0;
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            ...
            var dropRules = Main.ItemDropsDB.GetRulesForNPCID(NPCID.DesertGhoul, false);
