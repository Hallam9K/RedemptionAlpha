...
namespace Redemption.Particles
{
    public class SoulParticle : EmberParticle
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color lightColor)
        {
            ...
            spriteBatch.Draw(Redemption.SoftGlow.Value, VisualPosition, new Rectangle(0, 0, 64, 64), glowColor * (ai[1] + 1), rotation, new Vector2(32f, 32f), 1f * size * scale, SpriteEffects.None, 0f);
            spriteBatch.Draw(Redemption.Circle.Value, VisualPosition - new Vector2(1.5f, 1.5f), new Rectangle(0, 0, 64, 64), emberColor * (ai[1] + 1), rotation, Vector2.Zero, 1f * pixelRatio * 3f * size * scale, SpriteEffects.None, 0f);
            spriteBatch.Draw(Redemption.EmberParticle.Value, VisualPosition, new Rectangle(0, 0, 3, 3), color, rotation, new Vector2(1.5f, 1.5f), scale, SpriteEffects.None, 0f);
            return false;
        }
    }
}
