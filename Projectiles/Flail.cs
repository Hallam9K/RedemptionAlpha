...
namespace Redemption.Projectiles
{
    public abstract class Flail : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            float meleeSpeed = MathF.Sqrt(player.GetAttackSpeed(DamageClass.Melee));
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
			...
			*/
            OnTileCollide_Extra(oldVelocity);
            return false;
        }
        public virtual void OnTileCollide_Extra(Vector2 oldVelocity) { }
