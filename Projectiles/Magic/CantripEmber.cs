...
namespace Redemption.Projectiles.Magic
{
    public class CantripEmber : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int dust = Dust.NewDust(Projectile.Center + Projectile.velocity, 1, 1, DustType<GlowDust>(), 0, 0, 0, default, 0.2f);
                Main.dust[dust].noGravity = true;
                Main.dust[dust].color = new(253, 221, 3) { A = 0 };
                int dust2 = Dust.NewDust(Projectile.Center + Projectile.velocity, 1, 1, DustType<GlowDust>(), 0, 0, 0, default, 0.2f);
                Main.dust[dust2].noGravity = true;
                Main.dust[dust2].color = new(253, 62, 3) { A = 0 };
                RedeParticleManager.CreateAdditiveGlowParticle(Projectile.Center + Projectile.velocity, Vector2.Zero, Vector2.One * 0.5f, new(253, 62, 3), 8);
            }
    ...
    public class CantripEmberS : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.alpha < 255)
            {
                int dust = Dust.NewDust(Projectile.Center + Projectile.velocity, 1, 1, DustType<GlowDust>(), 0, 0, 0, default, 0.4f);
                Main.dust[dust].noGravity = true;
                Main.dust[dust].color = new(253, 221, 3) { A = 0 };
                int dust2 = Dust.NewDust(Projectile.Center + Projectile.velocity, 1, 1, DustType<GlowDust>(), 0, 0, 0, default, 0.4f);
                Main.dust[dust2].noGravity = true;
                Main.dust[dust2].color = new(253, 62, 3) { A = 0 };
                RedeParticleManager.CreateAdditiveGlowParticle(Projectile.Center + Projectile.velocity, Vector2.Zero, Vector2.One, new(253, 62, 3), 8);
            }
            if (Main.netMode != NetmodeID.Server)
            {
                TrailHelper.ManageBasicCaches(ref cache, ref cache2, NUMPOINTS, Projectile.Center);
                TrailHelper.ManageBasicTrail(RedeGraphics.Instance.Primitives, cache, cache2, ref trail, ref trail2, NUMPOINTS, Projectile.Center, baseColor, endColor, edgeColor, thickness);
            }
            if (fakeTimer > 0)
                FakeKill();
        }
