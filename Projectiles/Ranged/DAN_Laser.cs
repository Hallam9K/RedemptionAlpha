        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            ...
            for (int k = 0; k < 3; k++)
            {
                ...
                for (int i = -1; i <= 1; i += 2)
                {
                    ...
                    int p = Projectile.NewProjectile(Projectile.GetSource_FromAI(), origin, new Vector2(0, -6), ProjectileID.GeyserTrap, Projectile.damage / 3, Projectile.knockBack, player.whoAmI);
