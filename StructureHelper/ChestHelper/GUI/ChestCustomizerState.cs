...
{ 
    class ChestCustomizerState : UIState
    {
        ...
        UIImageButton NewGuaranteed = new UIImageButton(Request<Texture2D>("Redemption/StructureHelper/PlusR"));
        UIImageButton NewChance = new UIImageButton(Request<Texture2D>("Redemption/StructureHelper/PlusG"));
        UIImageButton NewPool = new UIImageButton(Request<Texture2D>("Redemption/StructureHelper/PlusP"));
        UIImageButton NewPoolChance = new UIImageButton(Request<Texture2D>("Redemption/StructureHelper/PlusB"));

        public static UIImageButton closeButton = new UIImageButton(Request<Texture2D>("Redemption/StructureHelper/Cross"));
