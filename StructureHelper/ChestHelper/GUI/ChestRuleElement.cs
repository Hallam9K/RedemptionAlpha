...
namespace Redemption.StructureHelper.ChestHelper.GUI
{
    class ChestRuleElement : UIElement
    {
        ...
        UIImageButton removeButton = new UIImageButton(ModContent.Request<Texture2D>("Redemption/StructureHelper/GUI/Cross"));

        UIImageButton upButton = new UIImageButton(ModContent.Request<Texture2D>("Redemption/StructureHelper/GUI/UpLarge"));
        UIImageButton downButton = new UIImageButton(ModContent.Request<Texture2D>("Redemption/StructureHelper/GUI/DownLarge"));
        UIImageButton hideButton = new UIImageButton(ModContent.Request<Texture2D>("Redemption/StructureHelper/GUI/Eye"));
		...
		private void Hide(UIMouseEvent evt, UIElement listeningElement)
		{
            if (storedHeight == 0)
            {
                hideButton.SetImage(ModContent.Request<Texture2D>("Redemption/StructureHelper/GUI/EyeClosed"));
                storedHeight = GetDimensions().Height;
                Height.Set(36, 0);
            }
			else
			{
                hideButton.SetImage(ModContent.Request<Texture2D>("Redemption/StructureHelper/GUI/Eye"));
