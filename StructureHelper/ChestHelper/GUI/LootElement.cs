...
namespace Redemption.StructureHelper.ChestHelper.GUI
{
    class LootElement : UIElement
    {
        ...
        UIImageButton upButton = new UIImageButton(ModContent.Request<Texture2D>("Redemption/StructureHelper/GUI/Up"));
        UIImageButton downButton = new UIImageButton(ModContent.Request<Texture2D>("Redemption/StructureHelper/GUI/Down"));
