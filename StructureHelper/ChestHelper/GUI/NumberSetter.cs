...
namespace Redemption.StructureHelper.ChestHelper.GUI
{
    class NumberSetter : UIElement
    {
        ...
        UIImageButton IncrementButton = new UIImageButton(ModContent.Request<Texture2D>("Redemption/StructureHelper/GUI/Up"));
        UIImageButton DecrementButton = new UIImageButton(ModContent.Request<Texture2D>("Redemption/StructureHelper/GUI/Down"));
