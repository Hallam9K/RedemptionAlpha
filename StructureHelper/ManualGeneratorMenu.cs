...
namespace Redemption.StructureHelper
{
	class ManualGeneratorMenu : UIState
	{
        ...
        public static UIImageButton refreshButton = new UIImageButton(ModContent.Request<Texture2D>("Redemption/StructureHelper/Refresh"));
        public static UIImageButton ignoreButton = new UIImageButton(ModContent.Request<Texture2D>("Redemption/StructureHelper/Null"));
        public static UIImageButton closeButton = new UIImageButton(ModContent.Request<Texture2D>("Redemption/StructureHelper/Cross"));
        ...
        public static void LoadStructures()
		{
            ...
            bool pathExists = Directory.Exists(ModLoader.ModPath.Replace("Mods", "SavedStructures"));
		...
		public override void Draw(SpriteBatch spriteBatch)
		{
            ...
            if (!ignoreNulls)
            {
                var tex = ModContent.Request<Texture2D>("Redemption/StructureHelper/Cross");
                spriteBatch.Draw((Texture2D)tex, ignoreButton.GetDimensions().ToRectangle(), ignoreButton.IsMouseHovering ? Color.White : Color.White * 0.5f);
            }
        }
        ...
        {
            Texture2D tex = (Texture2D)ModContent.Request<Texture2D>("Redemption/StructureHelper/Box");
