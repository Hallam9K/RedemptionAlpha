...
{
    public class HolochestTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            ChestDrop = ModContent.ItemType<Holochest>();

            // Names
            ContainerName.SetDefault("Holochest");
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            {
                player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Holochest";
