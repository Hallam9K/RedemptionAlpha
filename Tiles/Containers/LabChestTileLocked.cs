...
namespace Redemption.Tiles.Containers
{
    public class LabChestTileLocked : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Main.spriteBatch.Draw(ModContent.Request<Texture2D>("Redemption/Tiles/Containers/LabChestTileLocked_Glow").Value, new Vector2((i * 16) - (int)Main.screenPosition.X, (j * 16) - (int)Main.screenPosition.Y) + zero, new Rectangle(tile.frameX, tile.frameY, 16, height), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
        }
    }
}