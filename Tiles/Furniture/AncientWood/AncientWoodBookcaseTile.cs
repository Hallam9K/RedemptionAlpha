...
namespace Redemption.Tiles.Furniture.AncientWood
{
    public class AncientWoodBookcaseTile : ModTile
	{
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY) => Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 48, 64, ModContent.ItemType<AncientWoodBookcase>());
    }
}
