...
{
    public class AncientWoodDresserTile : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("Ancient Wood Dresser");
			AddMapEntry(new Color(109, 87, 78), name);
			ContainerName.SetDefault("Ancient Wood Dresser");
			AdjTiles = new int[] { TileID.Dressers };
			DresserDrop = ModContent.ItemType<AncientWoodDresser>();
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconText = "Ancient Wood Dresser";
				}
				if (player.cursorItemIconText == "Ancient Wood Dresser")
				{
					player.cursorItemIconID = ModContent.ItemType<AncientWoodDresser>();
