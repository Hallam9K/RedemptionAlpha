...
namespace Redemption.Tiles.Furniture.ElderWood
{
    public class ElderWoodClockTile : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("Elder Wood Clock");
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) => Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 48, 32, ModContent.ItemType<ElderWoodClock>());
	}
}