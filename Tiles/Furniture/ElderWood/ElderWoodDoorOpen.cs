...
namespace Redemption.Tiles.Furniture.ElderWood
{
    public class ElderWoodDoorOpen : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			CloseDoorID = ModContent.TileType<ElderWoodDoorClosed>();
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) => Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 48, ModContent.ItemType<ElderWoodDoor>());
