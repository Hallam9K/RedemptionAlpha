...
namespace Redemption.Tiles.Furniture.ElderWood
{
    public class ElderWoodDresserTile : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			ContainerName.SetDefault("Elder Wood Dresser");
			AdjTiles = new int[] { TileID.Dressers };
			DresserDrop = ModContent.ItemType<ElderWoodDresser>();
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconText = "Elder Wood Dresser";
				}
				if (player.cursorItemIconText == "Elder Wood Dresser")
				{
					player.cursorItemIconID = ModContent.ItemType<ElderWoodDresser>();
