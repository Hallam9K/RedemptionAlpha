...
{
    public class ElderWoodToiletTile : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            // Names
            AddMapEntry(new Color(109, 87, 78), Language.GetText("MapObject.Toilet"));
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<ElderWoodToilet>();
