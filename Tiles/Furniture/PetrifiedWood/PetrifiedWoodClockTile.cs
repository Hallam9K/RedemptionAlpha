...
{
    public class PetrifiedWoodClockTile : ModTile
    {
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) => Item.NewItem(i * 16, j * 16, 32, 80, ModContent.ItemType<PetrifiedWoodClock>());
	}
}