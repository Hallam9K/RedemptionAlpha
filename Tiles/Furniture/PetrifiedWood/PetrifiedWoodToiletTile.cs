...
{
    public class PetrifiedWoodToiletTile : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            // Names
            AddMapEntry(new Color(100, 100, 100), Language.GetText("MapObject.Toilet"));
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<PetrifiedWoodToilet>();
