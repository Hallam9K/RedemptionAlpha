...
{
    public class ShadestoneDresserTile : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("Shadestone Dresser");
			AddMapEntry(new Color(59, 61, 87), name);
			ContainerName.SetDefault("Shadestone Dresser");
			AdjTiles = new int[] { TileID.Dressers };
			DresserDrop = ModContent.ItemType<ShadestoneDresser>();
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconText = "Shadestone Dresser";
				}
				if (player.cursorItemIconText == "Shadestone Dresser")
				{
					player.cursorItemIconID = ModContent.ItemType<ShadestoneDresser>();
