...
{
    public class SilverwoodDresserTile : ModTile
	{
        public override void SetStaticDefaults()
        {
            ...
            name.SetDefault("Silverwood Dresser");
            AddMapEntry(new Color(228, 213, 173), name);
            ContainerName.SetDefault("Silverwood Dresser");
            AdjTiles = new int[] { TileID.Dressers };
            DresserDrop = ModContent.ItemType<SilverwoodDresser>();
        ...
        public override void MouseOverFar(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.cursorItemIconText = "Silverwood Dresser";
                }
                if (player.cursorItemIconText == "Silverwood Dresser")
                {
                    player.cursorItemIconID = ModContent.ItemType<SilverwoodDresser>();
