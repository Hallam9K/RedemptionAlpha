...
{
    public class SilverwoodToiletTile : ModTile
	{
        ...
        public override void SetStaticDefaults()
        {
            ...
            // Names
            AddMapEntry(new Color(228, 213, 173), Language.GetText("MapObject.Toilet"));
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<SilverwoodToilet>());
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<SilverwoodToilet>();
