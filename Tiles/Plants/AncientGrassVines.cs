...
namespace Redemption.Tiles.Plants
{
	public class AncientGrassVines : ModTile
	{
        ...
        public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(ModContent.Request<Texture2D>("Redemption/Tiles/Plants/AncientGrassVines").Value, drawPos + zero - new Vector2(xOff, 0), realSource, new Color(col.R, col.G, col.B, 255), 0f, new Vector2(0, 0), 1f, SpriteEffects.None, 0f);
            return false;
        }
