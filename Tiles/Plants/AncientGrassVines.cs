...
namespace Redemption.Tiles.Plants
{
    ...
    public class AncientGrassVineGlobalTile : GlobalTile
    {
        private int Vine;
        private int AncientGrass;

        public override void SetStaticDefaults()
        {
            Vine = TileType<AncientGrassVines>();
            AncientGrass = TileType<AncientGrassTile>();
        }

        private bool ValidTile(int tile) => tile == AncientGrass;
