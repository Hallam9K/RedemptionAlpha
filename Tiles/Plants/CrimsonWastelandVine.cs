...
{
    public class CrimsonWastelandVine : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(93, 69, 72));
    ...
    public class CrimsonWastelandVineGlobalTile : GlobalTile
    {
        private int Vine;
        private int Grass;
        ...
        public override void SetStaticDefaults()
        {
            Vine = TileType<CrimsonWastelandVine>();
            Grass = TileType<IrradiatedCrimsonGrassTile>();
        }
