...
{
    public class NooserootVines : ModTile
    {
        ...
        public override bool TileFrame(int i, int j, ref bool resetFrame, ref bool noBreak)
        {
            ...
            if (type == ModContent.TileType<ShadestoneBrickMossyTile>() || type == ModContent.TileType<ShadestoneMossyTile>() || type == Type)
                return true;
        ...
        public override void RandomUpdate(int i, int j)
        {
            ...
            if (WorldGen.genRand.NextBool(15) && !tileBelow.HasTile && tileBelow.LiquidType != LiquidID.Lava)
            {
                ...
                while (yTest > j - 10)
                {
                    ...
                    else if (!testTile.HasTile || (testTile.TileType != ModContent.TileType<ShadestoneBrickMossyTile>() && testTile.TileType != ModContent.TileType<ShadestoneMossyTile>()))
                    {
                        yTest--;
                        continue;
                    }
