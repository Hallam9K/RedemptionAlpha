...
namespace Redemption.Tiles.Tiles
{
    public class DeadGrassTileCorruption : ModTile
	{
		public override void SetStaticDefaults()
		{
            ...
            AddMapEntry(new Color(103, 101, 107));
            MinPick = 10;
            MineResist = 0.1f;
        ...
        public override void RandomUpdate(int i, int j)
        {
            ...
            WorldGen.SpreadGrass(i + Main.rand.Next(-1, 1), j + Main.rand.Next(-1, 1), TileID.Dirt, ModContent.TileType<DeadGrassTileCorruption>(), false, 0);
