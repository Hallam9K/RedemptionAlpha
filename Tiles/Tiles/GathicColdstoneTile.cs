...
{
    public class GathicColdstoneTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            Main.tileMerge[Type][ModContent.TileType<GathicColdstoneBrickTile>()] = true;
            ...
            RegisterItemDrop(ModContent.ItemType<GathicFroststone>());
            DustType = DustID.Ice;
