...
{
    public class HardenedSludgeTile : HardenedSludgeTileSafe
    {
    ...
    public class HardenedSludgeTileSafe : ModTile
    {
        public override string Texture => "Redemption/Tiles/Tiles/HardenedSludgeTile";
