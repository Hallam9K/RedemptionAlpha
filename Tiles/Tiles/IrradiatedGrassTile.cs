    ...
    public class IrradiatedGrassTile : ModTile
    {
        ...
        public override void RandomUpdate(int i, int j)
        {
            ...
            if (!tileAbove.HasTile && Main.tile[i, j].HasTile && Main.rand.NextBool(15) && Main.tile[i, j - 1].LiquidAmount == 0)
            {
                ...
                WorldGen.PlaceObject(i, j - 1, ModContent.TileType<PurityWastelandFoliage>(), true, rand);
                NetMessage.SendObjectPlacement(-1, i, j - 1, ModContent.TileType<PurityWastelandFoliage>(), rand, 0, -1, -1);
            }
