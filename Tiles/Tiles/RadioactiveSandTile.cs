...
namespace Redemption.Tiles.Tiles
{
    public class RadioactiveSandTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            SetModCactus(new RadioactiveCactus());
            SetModPalmTree(new DeadPalmTree());
            Main.tileMergeDirt[Type] = true;
            Main.tileMerge[Type][ModContent.TileType<RadioactiveSandstoneTile>()] = true;
            Main.tileMerge[ModContent.TileType<RadioactiveSandstoneTile>()][Type] = true;
            ...
            ItemDrop = ModContent.ItemType<RadioactiveSand>();
        }
    ...
    public class RadioactiveSandBall : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            tileType = ModContent.TileType<RadioactiveSandTile>();
            dustType = ModContent.DustType<RadioactiveSandDust>();
        }
        ...
        public override void Kill(int timeLeft)
        {
            if (Projectile.owner == Main.myPlayer && !Projectile.noDropItem)
            {
                ...
                if (!tile.IsActive)
                {
                    ...
                    {
                        Item.NewItem((int)Projectile.position.X, (int)Projectile.position.Y, Projectile.width, Projectile.height, ModContent.ItemType<RadioactiveSand>());
                    }
