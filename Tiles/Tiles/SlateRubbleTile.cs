...
{
    public class SlateRubbleTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            MinPick = 300;
            MineResist = 4f;
            AddMapEntry(new Color(58, 57, 59));
        }
        ...
        public override bool TileFrame(int i, int j, ref bool resetFrame, ref bool noBreak)
        {
            ...
            if (canFall)
            {
                int projectileType = ModContent.ProjectileType<SlateRubbleBall>();
    ...
    public class SlateRubbleBall : ModProjectile
    {
        ...
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Slate Rubble");
        ...
        public override void SetDefaults()
        {
            ...
            tileType = ModContent.TileType<SlateRubbleTile>();
            dustType = ModContent.DustType<SlateDust>();
        }
